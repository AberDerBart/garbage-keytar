...
static uint8_t adv_data[] = {
    ...
    // Name
    4, BLUETOOTH_DATA_TYPE_SHORTENED_LOCAL_NAME, 'G', 'C', 'K',
    // 10, BLUETOOTH_DATA_TYPE_COMPLETE_LOCAL_NAME, 'G', 'C', '-', 'K', 'e', 'y', 't', 'a', 'r',
    // 3, BLUETOOTH_DATA_TYPE_COMPLETE_LIST_OF_16_BIT_SERVICE_CLASS_UUIDS, 0x1a, 0x18,
    17, BLUETOOTH_DATA_TYPE_INCOMPLETE_LIST_OF_128_BIT_SERVICE_CLASS_UUIDS, 0x00, 0xc7, 0xc4, 0x4e, 0xe3, 0x6c, 0x51, 0xa7, 0x33, 0x4b, 0xe8, 0xed, 0x5a, 0x0e, 0xb8, 0x03,
};
