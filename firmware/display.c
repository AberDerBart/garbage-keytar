...
void display_task() {
  ...
  for (int i = 0; i < 8; i++) {
    if (i == 1 || i == 2 || i >= 4 && i <= 6) {
      // black keys
      ssd1306_draw_square(&disp, keyb_x + i * key_w, keyb_y + keyb_h / 2, 1,
                          keyb_h - keyb_h / 2);
      ssd1306_draw_square(&disp, keyb_x + i * key_w - key_w / 4, keyb_y, 1,
                          keyb_h / 2);
      ssd1306_draw_square(&disp, keyb_x + i * key_w + key_w / 4, keyb_y, 1,
                          keyb_h / 2);
      ssd1306_draw_square(&disp, keyb_x + i * key_w - key_w / 4,
                          keyb_y + keyb_h / 2 - 1, key_w / 4 * 2, 1);
    } else {
      // white keys
    ...
    // highlight key
    if (i == 1 && trans == 1 || i == 2 && trans == 3 || i == 4 && trans == 6 ||
        i == 5 && trans == 8 || i == 6 && trans == 10) {
      ssd1306_draw_square(&disp, keyb_x + i * key_w - key_w / 4, keyb_y,
                          key_w / 4 * 2, keyb_h / 2);
    } else if (i == 0 && trans == 0 || i == 1 && trans == 2 ||
               i == 2 && trans == 4 || i == 3 && trans == 5 ||
               i == 4 && trans == 7 || i == 5 && trans == 9 ||
               i == 6 && trans == 11) {
      ssd1306_draw_square(&disp, keyb_x + i * key_w, keyb_y + keyb_h / 2, key_w,
                          keyb_h - keyb_h / 2);

      if (i == 0 || i == 3) {
        ssd1306_draw_square(&disp, keyb_x + i * key_w, keyb_y,
                            key_w - key_w / 4, keyb_h / 2);
      } else if (i == 2 || i == 6) {
        ssd1306_draw_square(&disp, keyb_x + i * key_w + key_w / 4, keyb_y,
                            key_w - key_w / 4, keyb_h / 2);
      } else {
        ssd1306_draw_square(&disp, keyb_x + i * key_w + key_w / 4, keyb_y,
                            key_w - 2 * key_w / 4, keyb_h / 2);
      }
    }
  }
